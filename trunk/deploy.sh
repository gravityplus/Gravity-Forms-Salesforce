...
# main config
PLUGINSLUG="gravity-forms-salesforce" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="salesforce-api.php" # this should be the name of your main php file in the wordpress plugin
